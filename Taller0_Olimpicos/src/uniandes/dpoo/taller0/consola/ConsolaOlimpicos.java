...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("15. Salir de la aplicación\n");
	}

	/**
	 * Le muestra el usuario el pais de un atleta
	 */
	private void ejecutarPaisdeAtleta()
	{
		System.out.println("\n" + "Pais al que pertenece un atleta" + "\n");

		String atleta = input("Ingrese nombre del atleta: ");
